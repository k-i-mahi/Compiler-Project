/* Auto-generated C file from Linear source: .\samples\demo_pipeline.linear */
#include <stdio.h>

/*
 * Original Linear source (for reference)
 */
// START main {
...
//     float pi = 3.14;
//     bool ok = true;
//     string title = "All-features demo";
// 
//     MAHI_write(title);
...
int main(void) {
    puts("This .generated.c file was auto-created during Linear compilation.");
    puts("Source: .\samples\demo_pipeline.linear");
    return 0;
}
